...
/// <summary>
///     On-demand golden harvester (deterministic, no model). Scans an agent's most-recent thumbs-up assistant
///     turns and proposes <see cref="GoldenConversationSource.Harvested" /> candidates (the lead-up turns + the
///     operator-approved answer seeded as a rubric, judge path), staged inert until the operator approves them into the active
