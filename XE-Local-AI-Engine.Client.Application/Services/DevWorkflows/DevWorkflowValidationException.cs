...
/// </summary>
/// <remarks>
///     The third of the three exception types that cross the run service's boundary, alongside
///     <c>DevWorkflowNotFoundException</c> and <c>DevWorkflowInvalidTransitionException</c> from the store; the API
