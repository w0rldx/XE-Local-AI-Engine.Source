...
///     file name, a model name and a family.
/// </summary>
/// <remarks>
///     Bundled-only: unlike the GGUF catalog there is no remote refresh, because the entries carry exact per-file
///     sizes verified against the Hub before shipping, and a stale remote copy would silently reintroduce the
///     404-on-install failure the catalog exists to prevent.
/// </remarks>
