...
{
    public NodeSettingsUnreadableException(string settingsPath) : base(
        $"The node settings file at '{settingsPath}' could not be read, so nothing was written. Repair or delete node-settings.json and try again.")
    {
