...
///     staging step to copy into the sandbox via its guarded copy-in path.
/// </summary>
/// <remarks>
///     Disposing removes the directory; callers must dispose, ideally with <c>await using</c>, so plaintext never lingers
///     on disk.
/// </remarks>
