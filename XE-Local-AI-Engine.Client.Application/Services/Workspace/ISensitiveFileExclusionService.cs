...
/// <summary>
///     Decides whether a selected-folder entry must be excluded from the sandbox workspace copy (AgentHome plan §8.3,
///     Marker F). Excludes secrets (<c>.env</c>, <c>.ssh</c>, credential bundles), the host <c>.git</c> baseline, and
