...
public sealed record McpWorkspaceListResponse(
    ...
    [property: JsonPropertyName("workspaces")] IReadOnlyList<McpWorkspaceSummary> Workspaces,
    [property: JsonPropertyName("count")] int Count,
    [property: JsonPropertyName("truncated")] bool Truncated,
    [property: JsonPropertyName("failure_code")] string? FailureCode = null,
    [property: JsonPropertyName("display_message")] string? DisplayMessage = null);
...
public sealed record McpAgentRunListResponse(
    [property: JsonPropertyName("status")] string Status,
    [property: JsonPropertyName("runs")] IReadOnlyList<McpAgentRunSummary> Runs,
    [property: JsonPropertyName("count")] int Count,
...
public sealed record McpAgentRunSummary(
    ...
    [property: JsonPropertyName("failure_code")] string? FailureCode,
    [property: JsonPropertyName("display_message")] string? DisplayMessage,
    [property: JsonPropertyName("created_at_unix_ms")] long CreatedAtUnixMilliseconds,
    [property: JsonPropertyName("claimed_at_unix_ms")] long? ClaimedAtUnixMilliseconds,
    [property: JsonPropertyName("completed_at_unix_ms")] long? CompletedAtUnixMilliseconds,
    [property: JsonPropertyName("payload_expires_at_unix_ms")] long? PayloadExpiresAtUnixMilliseconds,
    [property: JsonPropertyName("compacted_at_unix_ms")] long? CompactedAtUnixMilliseconds,
    [property: JsonPropertyName("result_expired")] bool ResultExpired,
    [property: JsonPropertyName("compacted")] bool Compacted);
...
public sealed record McpAgentRunDetail(
    [property: JsonPropertyName("metadata")] McpAgentRunSummary Metadata,
    [property: JsonPropertyName("result")] string? Result,
    [property: JsonPropertyName("result_truncated")] bool ResultTruncated);
...
internal static class McpAgentToolResponseMapper
{
    ...
    public static string ToExternalValue<TEnum>(TEnum value)
        where TEnum : struct, Enum => McpAgentRunText.ToLowercaseInvariant(value);
}
