...
/// <summary>What one application container is told about the bridge: where to call, and the credential to call with.</summary>
/// <remarks>
...
{
    // The token is a live credential for this node's inference surface, so the generated ToString() would put it in
    // any log line formatting a plan. Suppressed like the instance snapshot's: impossible, not merely forbidden.
