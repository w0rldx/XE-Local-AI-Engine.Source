...
///     (<c>ResolveModelCapabilitiesAsync</c> in <c>NodeChatStreamService</c> / <c>NodeChatRegenerationService</c>) and
///     the <c>/models</c> <c>IsToolCapable</c> tag in <c>LocalModelsMapper</c>. Tool calling is enabled for all Azure
