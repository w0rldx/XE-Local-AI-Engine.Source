...
///     client, scope — device-code carries no secret).
/// </summary>
/// <remarks>
///     Shared by the sign-in coordinator (writer, on success) and the chat-client factory (reader, on every send), so
///     a completed sign-in is found by the very next send.
/// </remarks>
