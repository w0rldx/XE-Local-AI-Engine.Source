...
internal static class PlaybookRetrievalSelector
{
    ...
    ///     (static prepend, byte-identical to pre-P5). Otherwise the <paramref name="ranker" /> selects the top
    ...
    /// </summary>
    public static IReadOnlyList<PlaybookActionRecord> Select(IPlaybookRetrievalRanker ranker,
        ...
        int topK)
    {
        ...
        var selected = ranker.SelectTopK(retrievalQuery, enabled, topK);
