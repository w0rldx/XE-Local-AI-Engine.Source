...
/// <summary>
///     Names a model's attention shape from GGUF numbers alone, never from the architecture string, which is a label
///     an author chooses and not a fact about the cache.
/// </summary>
/// <remarks>The tag is presentation and a ranking tiebreak's companion; it never gates a launch.</remarks>
public static class AttentionArchTag
{
    ...
    /// </summary>
    /// <remarks>
    ///     Order matters: MLA is checked first because an MLA model's other numbers still look ordinary, and an
