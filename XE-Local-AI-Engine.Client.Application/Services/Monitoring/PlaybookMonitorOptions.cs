...
/// <summary>Options for the relevance retrieval and cohort monitoring cohort monitor.</summary>
/// <remarks>
///     <see cref="ImprovementEpsilon" /> is the dead-band around the before/after down-vote rate within which a change is treated as Flat;
///     <see cref="MinSampleSize" /> is the minimum after-enable sample count below which the verdict is InsufficientData and the action is
///     never flagged (mirrors the established feedback floor of 3).
/// </remarks>
