...
public sealed class InvocationThroughput
{
    ...
    /// <summary>Milliseconds spent on prompt processing, summed across every request.</summary>
    public double? PromptMs { get; init; }

    /// <summary>Tokens decoded, summed across every request.</summary>
    public int? GenerationTokens { get; init; }

    /// <summary>Milliseconds spent decoding, summed across every request.</summary>
