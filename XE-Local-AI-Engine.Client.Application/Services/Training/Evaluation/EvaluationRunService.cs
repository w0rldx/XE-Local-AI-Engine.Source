...
///     SAME training run's freeze, so the base model and the tuned model answer exactly the same questions. Deriving a
///     fresh split per side would make the two accuracies incomparable while looking like they compared something.
/// </remarks>
