...
///     <para>
///         Adds no members, for the same reason as <see cref="IAgentSandboxRuntimeProvider" />: provider selection is
///         per feature, and a role-scoped marker turns that into something the compiler
