...
/// <summary>A Docker daemon interaction failed, classified into the outcome an operator can act on.</summary>
/// <remarks>
///     Carrying the <see cref="Status" /> rather than only a message is what lets the preflight distinguish "no daemon" from "permission
///     denied" from "too old" without pattern-matching on daemon prose, which changes between releases.
/// </remarks>
