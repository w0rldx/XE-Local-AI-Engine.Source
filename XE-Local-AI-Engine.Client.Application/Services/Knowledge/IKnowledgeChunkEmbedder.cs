...
/// <summary>
///     Embeds a document's chunk texts through the node-local embedding provider and returns one little-endian
///     <c>float32</c> BLOB per chunk (aligned by index to the input). Applies the document embedding prefix and batches
///     the work; a transport/model failure or a dimension/count mismatch throws a content-free
