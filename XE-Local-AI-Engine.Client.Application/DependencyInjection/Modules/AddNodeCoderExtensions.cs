...
internal static class AddNodeCoderExtensions
{
    public static IHostApplicationBuilder AddNodeCoder(this IHostApplicationBuilder builder, IConfiguration configuration)
    {
        ...
        // same AgentHome:Enabled flag — there is no Coder:Enabled (decision 8). The handlers, reader, and options are
        // all Singleton (decision 9): ClientLocalToolRegistry captures the IClientLocalToolHandler IEnumerable at
