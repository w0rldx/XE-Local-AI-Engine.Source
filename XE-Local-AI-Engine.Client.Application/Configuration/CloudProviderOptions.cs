...
public sealed class CloudProviderOptions
{
    ...
    // of truth. No startup seam currently seeds the encrypted store from these values; see plan §7.8 (follow-up:
    // wire a first-run seed if a seamless hosting hook is added).
