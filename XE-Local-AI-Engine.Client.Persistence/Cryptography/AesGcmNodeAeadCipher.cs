...
/// <summary>
///     AES-256-GCM implementation of <see cref="INodeAeadCipher" /> with a 12-byte nonce and a 16-byte tag.
/// </summary>
/// <remarks>
///     The node's single owner of <see cref="AesGcm" /> construction and of the tag-size constant: both the at-rest
///     column protector and the streaming envelope crypto delegate their authenticated transform here.
/// </remarks>
