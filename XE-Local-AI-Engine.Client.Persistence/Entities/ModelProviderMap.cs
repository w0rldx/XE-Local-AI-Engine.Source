...
///     model name (<c>NOCASE</c>).
/// </summary>
/// <remarks>
///     Not encrypted — a model name and a provider key are not secrets. This is the resume-safe routing record the
///     model-routing client and the preview/embeddings resolvers read so a selected model resolves to the right
///     runtime across node restarts.
/// </remarks>
internal sealed record class ModelProviderMap
{
    ...
    /// <summary>Opaque compare-and-swap token regenerated by every successful mutation.</summary>
