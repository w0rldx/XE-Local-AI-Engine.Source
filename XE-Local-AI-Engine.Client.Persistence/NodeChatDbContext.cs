namespace XE_Local_AI_Engine.Client.Persistence
{
    ...
    public sealed class NodeChatDbContext : DbContext
    {
        ...
        private static void ConfigureConversation(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<NodeConversation> builder)
        {
        ...
        private static void ConfigureMessage(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<NodeMessage> builder)
        {
        ...
        private static void ConfigureToolEvent(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<NodeToolEvent> builder)
        {
        ...
        private static void ConfigurePurgedTombstone(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<NodePurgedTombstone> builder)
        {
