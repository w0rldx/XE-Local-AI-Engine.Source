...
internal sealed class GtkNativeApi : IDisposable
{
    ...
    internal static GtkNativeApi Create()
    {
        ...
        try
        {
            foreach (var name in new[] { "libwebkit2gtk-4.1.so.0", "libgobject-2.0.so.0", "libsoup-3.0.so.0", "libgtk-3.so.0", "libglib-2.0.so.0" })
            {
    ...
    internal T WebKit<T>(string name) where T : Delegate => Export<T>(_webkit, name);
    internal T Gtk<T>(string name) where T : Delegate => Export<T>(_gtk, name);
    internal T Glib<T>(string name) where T : Delegate => Export<T>(_glib, name);
    internal T Object<T>(string name) where T : Delegate => Export<T>(_objects, name);
    ...
    internal static string? Text(nint pointer) => pointer == 0 ? null : Marshal.PtrToStringUTF8(pointer);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] internal delegate nint Pointer(nint instance);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] internal delegate void Command(nint instance);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] internal delegate int Predicate(nint instance);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] internal delegate uint Unsigned(nint instance);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] internal delegate ulong UnsignedLong(nint instance);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] internal delegate nuint GetTypeId();
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] internal delegate int IsType(nint instance, nuint type);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] internal delegate int PermissionCallback(nint view, nint request, nint data);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] internal delegate void EventCallback(nint instance, nint data);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] internal delegate void ObjectCallback(nint instance, nint other, nint data);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] internal delegate void LoadCallback(nint view, int state, nint data);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] internal delegate void DataCallback(nint download, ulong length, nint data);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] internal delegate int DecideCallback(nint download, nint suggested, nint data);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] internal delegate nint StringPointer(nint instance, [MarshalAs(UnmanagedType.LPUTF8Str)] string value);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] internal delegate void SetString(nint instance, [MarshalAs(UnmanagedType.LPUTF8Str)] string value);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] internal delegate void SetBoolean(nint instance, int value);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] private delegate nint OpenLibrary([MarshalAs(UnmanagedType.LPUTF8Str)] string name, int flags);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] private delegate int CloseLibrary(nint handle);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] private delegate ulong ConnectSignal(nint instance, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, nint callback, nint data, nint destroy, int flags);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] private delegate void DisconnectSignal(nint instance, ulong signal);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] private delegate void HeaderCallback(nint name, nint value, nint data);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)] private delegate void VisitHeaders(nint headers, nint callback, nint data);
}
