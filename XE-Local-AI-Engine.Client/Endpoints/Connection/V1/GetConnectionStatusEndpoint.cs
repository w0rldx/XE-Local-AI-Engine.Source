...
public sealed class GetConnectionStatusEndpoint : EndpointWithoutRequest<ConnectionStatusResponse>
{
    private readonly IConnectionControlService _connectionControlService;

    public GetConnectionStatusEndpoint(IConnectionControlService connectionControlService)
    {
