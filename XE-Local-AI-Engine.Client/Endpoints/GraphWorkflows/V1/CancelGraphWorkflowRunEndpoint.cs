...
/// <summary>
///     Asks the run to cancel: 202, and the body reads <c>Cancelling</c>.
/// </summary>
/// <remarks>
///     Live node runs drain first — each lane is asked to stop rather than having a terminal status written over work
///     still in flight — so a 200 would tell a schema-trusting client the cancel had finished. A run that is already
///     terminal answers 409.
/// </remarks>
