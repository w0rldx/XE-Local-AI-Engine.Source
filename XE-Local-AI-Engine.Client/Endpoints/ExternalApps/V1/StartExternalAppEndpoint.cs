...
///     </para>
/// </summary>
public sealed class StartExternalAppEndpoint(IExternalAppService apps)
    : Endpoint<ExternalAppInstanceCommandRequest, ExternalAppInstanceSummaryView>
{
    ...
    public override async Task HandleAsync(ExternalAppInstanceCommandRequest req, CancellationToken ct)
    {
        ...
        var summary = await _apps.StartAsync(req.InstanceId, req.ExpectedVersion!.Value, ct).ConfigureAwait(false);
