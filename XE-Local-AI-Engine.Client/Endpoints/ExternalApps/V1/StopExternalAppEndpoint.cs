...
///     </para>
/// </summary>
public sealed class StopExternalAppEndpoint(IExternalAppService apps)
    : Endpoint<ExternalAppInstanceCommandRequest, ExternalAppInstanceSummaryView>
{
    ...
    public override async Task HandleAsync(ExternalAppInstanceCommandRequest req, CancellationToken ct)
    {
        ...
        var summary = await _apps.StopAsync(req.InstanceId, req.ExpectedVersion!.Value, ct).ConfigureAwait(false);
