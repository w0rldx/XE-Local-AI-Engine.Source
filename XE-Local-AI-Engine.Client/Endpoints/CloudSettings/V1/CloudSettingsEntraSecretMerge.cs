...
///     mirroring <see cref="CloudSettingsHeaderMerge" />.
/// </summary>
/// <remarks>
///     A blank incoming secret keeps the previously stored one ONLY when the existing connection was already EntraId
///     and had a secret stored. A fresh connection, an auth-mode switch, or a blank secret with nothing stored NEVER
///     inherits, so a secret is never resurrected across a mode change.
/// </remarks>
