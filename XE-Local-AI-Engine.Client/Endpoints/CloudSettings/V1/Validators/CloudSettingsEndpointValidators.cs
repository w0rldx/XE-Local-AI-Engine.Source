namespace XE_Local_AI_Engine.Client.Endpoints.CloudSettings.V1.Validators;
...
public sealed class SaveCloudSettingsRequestValidator : Validator<SaveCloudSettingsRequest>
{
    public SaveCloudSettingsRequestValidator()
    {
        ...
        // Entra ID requires a tenant, client id, and token scope regardless of sign-in shape (a frozen build
        // contract) — the client secret is optional, and its absence selects interactive user sign-in.
