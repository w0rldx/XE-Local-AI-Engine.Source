...
/// <summary>
///     Tree-kills the resident <c>whisper-server</c> daemon to free its memory. Operator-gated.
/// </summary>
/// <remarks>
///     Refuses with <c>409 runtime-busy</c> while a transcription or a spawn is in flight, carrying the activity
///     snapshot so the operator can see what to wait for rather than being told only that it failed.
/// </remarks>
