...
/// <summary>
///     Validates a per-application capture request.
/// </summary>
/// <remarks>
///     The only field to check is the process id: WASAPI's <c>WithProcessLoopback</c> takes a <c>uint</c>, so a zero
///     or negative id is not a process that could ever be captured and is rejected before a recorder is built.
/// </remarks>
