...
///     (deterministic, no model). Operator-gated.
/// </summary>
/// <remarks>
///     Returns the per-run counts; 404 when the agent does not exist. A route-only POST: the client posts <c>{}</c>,
///     because FastEndpoints 415s a truly empty body.
/// </remarks>
