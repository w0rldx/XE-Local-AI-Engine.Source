...
/// </summary>
/// <remarks>
///     A deliberate typed DTO rather than the shared <c>ConflictProblemDetails</c> envelope, because the SPA branches
///     on <c>reason</c> and renders the <c>activity</c> snapshot. Keeping the envelope here means the four endpoints
///     that produce it cannot drift apart, and the busy reason code exists once.
/// </remarks>
