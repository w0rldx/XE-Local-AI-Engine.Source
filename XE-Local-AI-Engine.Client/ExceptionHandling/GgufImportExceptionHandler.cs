...
///     mapping was already in one place, only the catch was duplicated. The status split (409 / 404 / 507 / 400) and
///     the <c>GgufImportErrorResponse</c> body are <see cref="GgufImportEndpointSupport.Error" />'s, unchanged.
/// </remarks>
