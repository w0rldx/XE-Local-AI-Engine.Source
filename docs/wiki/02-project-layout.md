...
| `XE-Local-AI-Engine.Client.Application` | `Microsoft.NET.Sdk` | The **application layer**: ~28 service areas containing decisions/orchestration (chat, agents, scheduler, model-fit, capacity, etc.). Depends on every provider + persistence + agent + contracts. See [03-local-runtime-and-providers.md](03-local-runtime-and-providers.md), [05-chat.md](05-chat.md), [06-scheduler.md](06-scheduler.md), [07-model-fit.md](07-model-fit.md). |
