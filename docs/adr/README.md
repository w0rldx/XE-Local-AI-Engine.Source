...
| [0004 — Docker permitted for Development Mode execution only, as a stopgap ahead of MXC](0004-development-mode-container-execution-docker-stopgap.md) | **Proposed** | Narrows the epic's "no Docker anywhere" decision to "no Docker on the inference path"; amends `2026-06-17-runtime-rearchitecture-epic.md` `:29` and `:46`. **Not yet in force.** |
