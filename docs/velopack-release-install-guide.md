...
|---|---|---|
| Windows x64 | `XE-Local-AI-Engine-win-Portable.zip` | Framework-dependent; ASP.NET Core Runtime 10.0.11+ x64 required; no installer |
...
The Windows package does not bundle .NET. Install the x64 ASP.NET Core Runtime 10.0.11 or a newer .NET 10 servicing
