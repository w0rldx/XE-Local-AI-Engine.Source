...
- Live on this box (RTX 5090, b10201 CUDA, 200 chunks at 512): `unsloth/Qwen3.8-27B-GGUF` Q4_K_M **6.7983 ± 0.07405** vs UD-Q3_K_XL **6.9513 ± 0.07553** — separated, with the bands touching but not overlapping. At the 50-chunk floor the errors roughly double and the two would overlap, which is why the PPL default is 200 even though KLD's is lower.
