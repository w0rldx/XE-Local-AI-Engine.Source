...
describe("layout breakpoints", () => {
	it("matches the theme sm breakpoint for the compact-controls cutoff", () => {
		expect(COMPACT_CONTROLS_BREAKPOINT).toBe(sourceThemeConfiguration.breakpoints.values.sm);
	});
