...
export const zXeLocalAiEngineHostAgentAbstractionsContractsRuntimeComponentStatusDto = z.object({
	name: z.string().optional(),
	desiredState: zXeLocalAiEngineHostAgentAbstractionsContractsContainerDesiredState.optional(),
...
export const zXeLocalAiEngineClientEndpointsRuntimeManagerV1RuntimeContainerActionResponse = z.object({
...
export const zXeLocalAiEngineClientEndpointsRuntimeManagerV1RuntimeContainerActionRequest = z.object({
	containerName: z.string().nullish(),
	action: z.string().nullish(),
	drainTimeoutSeconds: z
		.int()
		.min(-2147483648, { error: "Invalid value: Expected int32 to be >= -2147483648" })
		.max(2147483647, { error: "Invalid value: Expected int32 to be <= 2147483647" })
		.nullish(),
...
export const zXeLocalAiEngineHostAgentAbstractionsContractsHostAgentStatusDto = z.object({
	...
	desiredState: zXeLocalAiEngineHostAgentAbstractionsContractsHostAgentDesiredState.optional(),
...
export const zXeLocalAiEngineHostAgentAbstractionsContractsHostCapabilitiesDto = z.object({
	cpuAvailable: z.boolean().optional(),
	nvidiaGpuInference: z.boolean().optional(),
	gpuRuntimeConfigured: z.boolean().optional(),
	amdGpuStatus: z.string().optional(),
	runtimeDiskBytes: z.coerce
		.bigint()
		.min(BigInt("-9223372036854775808"), { error: "Invalid value: Expected int64 to be >= -9223372036854775808" })
		.max(BigInt("9223372036854775807"), { error: "Invalid value: Expected int64 to be <= 9223372036854775807" })
		.optional(),
...
export const zXeLocalAiEngineClientEndpointsRuntimeManagerV1RuntimeLocalModelResponse = z.object({
...
export const zXeLocalAiEngineClientEndpointsRuntimeManagerV1RuntimeManifestEnvironmentResponse = z.object({
	name: z.string().optional(),
	value: z.string().optional(),
});

export const zXeLocalAiEngineClientEndpointsRuntimeManagerV1RuntimeManifestVolumeResponse = z.object({
	source: z.string().optional(),
	target: z.string().optional(),
	readOnly: z.boolean().optional(),
});

export const zXeLocalAiEngineClientEndpointsRuntimeManagerV1RuntimeManifestContainerResponse = z.object({
	name: z.string().optional(),
	image: z.string().optional(),
	network: z.string().optional(),
	environment: z.array(zXeLocalAiEngineClientEndpointsRuntimeManagerV1RuntimeManifestEnvironmentResponse).optional(),
	volumes: z.array(zXeLocalAiEngineClientEndpointsRuntimeManagerV1RuntimeManifestVolumeResponse).optional(),
});

export const zXeLocalAiEngineClientEndpointsRuntimeManagerV1RuntimeManifestResponse = z.object({
	...
	maxRuntimeDiskGb: z
		...
		.max(2147483647, { error: "Invalid value: Expected int32 to be <= 2147483647" })
		.nullish(),
	stopDrainTimeoutSeconds: z
		.int()
		.min(-2147483648, { error: "Invalid value: Expected int32 to be >= -2147483648" })
		.max(2147483647, { error: "Invalid value: Expected int32 to be <= 2147483647" })
		.nullish(),
	containers: z.array(zXeLocalAiEngineClientEndpointsRuntimeManagerV1RuntimeManifestContainerResponse).optional(),
	diagnostics: z.array(z.string()).optional(),
});

export const zXeLocalAiEngineClientEndpointsRuntimeManagerV1RuntimeManagerStatusResponse = z.object({
	status: zXeLocalAiEngineHostAgentAbstractionsContractsHostAgentStatusDto.optional(),
	capabilities: zXeLocalAiEngineHostAgentAbstractionsContractsHostCapabilitiesDto.optional(),
	components: z.array(zXeLocalAiEngineHostAgentAbstractionsContractsRuntimeComponentStatusDto).optional(),
	modelProviderHealth: zXeLocalAiEngineClientEndpointsRuntimeManagerV1RuntimeModelProviderHealthResponse.optional(),
	models: z.array(zXeLocalAiEngineClientEndpointsRuntimeManagerV1RuntimeLocalModelResponse).optional(),
...
export const zXeLocalAiEngineClientEndpointsNodeSettingsV1SaveNodeSettingsRequest = z.object({
	maxMessageRequestTimeoutSeconds: z.int().gte(5).lte(3600).optional(),
	defaultModelName: z.string().nullish(),
});
...
export const zExecuteRuntimeContainerActionBody = zXeLocalAiEngineClientEndpointsRuntimeManagerV1RuntimeContainerActionRequest;

/**
 * Success
 */
export const zExecuteRuntimeContainerActionResponse =
	zXeLocalAiEngineClientEndpointsRuntimeManagerV1RuntimeContainerActionResponse;
