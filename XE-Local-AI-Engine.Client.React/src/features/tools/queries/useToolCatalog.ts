...
// Server state for the dynamic tool catalog (loop P4): node built-ins plus the tools discovered from enabled
...
// the static localToolCatalog const. Mutating the MCP server set (Lane 4 CRUD) invalidates this query so the
