	...
	return (
		<PageShell data-testid="work-sessions-page">
			...
			{listQuery.isPending ? (
				...
				<InlineErrorAlert
					message={apiErrorMessage(listQuery.error, t("pages.workSessions.loadFailed", "Could not load work sessions."))}
					variant="light"
					data-testid="work-sessions-error"
				>
					<Button
						size="xs"
						variant="light"
				...
				<Alert color="blue" variant="light" data-testid="work-sessions-empty">
					<Stack gap="sm" align="flex-start">
						<Text size="sm">
							{t(
								"pages.workSessions.empty",
								"No work sessions yet. Give an agent an objective and it will plan and run the work.",
							)}
						</Text>
						...
						>
							<Stack gap="xs">
								...
								<Group gap="xs" wrap="wrap">
									<WorkSessionStatusBadge
										status={toWorkSessionStatus(session.status)}
										testId={`work-session-card-status-${session.id}`}
									/>
