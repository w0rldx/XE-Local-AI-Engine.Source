...
// each mutation's dispatched wire envelope can be asserted. listAgentDefinitionsOptions/getToolCapableModelsOptions
// return a hey-api options object ({ queryKey, queryFn }); each *Mutation returns an object whose mutationFn the hook
// dispatches into.
