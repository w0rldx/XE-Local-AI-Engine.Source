import { Alert, Grid, Paper, Stack, Text } from "@mantine/core";
	...
	return (
		<Stack gap="md" h="100%" mih={620}>
			...
			<Grid gap={0} style={{ flex: 1, minHeight: 0 }}>
				<Grid.Col span={conversationListCollapsed ? 1 : 3} style={{ minHeight: 0 }}>
					<ConversationList
				...
				<Grid.Col span={conversationListCollapsed ? 11 : 9} style={{ minHeight: 0 }}>
					<Paper
						withBorder={true}
						p="md"
						h="100%"
						style={{ display: "flex", flexDirection: "column", minHeight: 0, borderRadius: "0 var(--mantine-radius-md) var(--mantine-radius-md) 0" }}
					>
