...
const GENERATED_NOTICE = "AUTO-GENERATED by scripts/GenerateLicenses.mjs (pnpm run licenses:generate). DO NOT EDIT BY HAND.";
...
const EXCLUDED_NATIVE_BINARY_PATTERNS = [/^@rollup\/rollup-(?:linux|darwin|win32|freebsd|android|openharmony)-[a-z0-9-]+$/i];
