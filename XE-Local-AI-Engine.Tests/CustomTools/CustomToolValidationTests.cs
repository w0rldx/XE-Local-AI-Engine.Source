...
public sealed class CustomToolValidationTests
{
    ...
    [Arguments("/bin/busybox")]
    [Arguments("/usr/bin/tar")]
    [Arguments("/usr/bin/git")]
    [Arguments("/usr/bin/make")]
    [Arguments("/usr/bin/gdb")]
    [Arguments("/usr/bin/nc")]
    [Arguments("/usr/bin/ncat")]
    [Arguments("/usr/bin/socat")]
    [Arguments("/usr/bin/lua")]
    [Arguments("/usr/bin/php")]
    [Arguments("/usr/bin/deno")]
    [Arguments("/usr/bin/bun")]
    [Arguments("/usr/bin/rscript")]
    [Arguments("/usr/bin/osascript")]
    [Arguments("/usr/bin/tclsh")]
