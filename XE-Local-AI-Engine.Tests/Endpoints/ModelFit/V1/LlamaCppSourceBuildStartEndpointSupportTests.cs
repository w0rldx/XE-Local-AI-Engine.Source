...
/// <summary>
///     Pins the start-outcome → 409 reason/message mapping the source-build start endpoint returns. The endpoint
///     returned byte-for-byte these strings before the duplicated switches were folded together, and the build-kind
///     label is the only wording a second start surface could vary.
/// </summary>
