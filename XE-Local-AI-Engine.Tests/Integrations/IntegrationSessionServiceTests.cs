...
public sealed class IntegrationSessionServiceTests
{
    ...
    public async Task List_OrdersByLastActivityThenId_AndPagesDeterministically()
    {
        ...
        var first = await harness.SessionService.ListAsync(new IntegrationSessionFilter
        {
            TriggerId = null,
            Status = null,
            Limit = 3,
        ...
        var second = await harness.SessionService.ListAsync(new IntegrationSessionFilter
        {
            TriggerId = null,
            Status = null,
            Limit = 3,
    ...
    public async Task List_FiltersByStatusAndTriggerServerSide()
    {
        ...
        var byStatus = await harness.SessionService.ListAsync(new IntegrationSessionFilter
        {
            TriggerId = null,
        ...
        var byTrigger = await harness.SessionService.ListAsync(new IntegrationSessionFilter
        {
            TriggerId = mine.Id,
            Status = null,
            Limit = 50,
