...
public sealed class BenchmarkRunEventBufferTests
{
    ...
    public void Replay_TrimsByUtf8ByteBudgetAndResetsWhenAfterSequencePredatesRetainedWindow()
    {
        ...
        var probeBytes = JsonSerializer.SerializeToUtf8Bytes(new BenchmarkRunStreamEvent
            {
                RunId = runId,
                Sequence = 1,
                Kind = BenchmarkRunStreamEventKind.OutputDelta,
                Payload = new BenchmarkRunStreamPayload
                {
                    Content = payload
                }
            },
    ...
    public void EvictPlaintext_ForARunEvictedOncePerPhase_OccupiesExactlyOneRetainedSlot()
    {
        ...
        _ = buffer.Append(first, BenchmarkRunStreamEventKind.OutputDelta, new BenchmarkRunStreamPayload
        {
            Content = "primary"
        });
        ...
        _ = buffer.Append(second, BenchmarkRunStreamEventKind.OutputDelta, new BenchmarkRunStreamPayload
        {
            Content = "primary"
        });
