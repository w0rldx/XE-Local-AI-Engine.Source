...
public sealed class DevelopmentRoundFeedbackTests
{
    ...
    private static DevelopmentTaskSnapshot Task() =>
        new()
        {
            ...
            Status = DevelopmentTaskStatus.InReview,
    ...
    private static DevelopmentExecutionSnapshot Snapshot(string? previousRoundFeedback,
        ...
        new()
        {
            ...
            TrustedRepositoryAcknowledgedAtUtc = DateTimeOffset.UnixEpoch.ToUnixTimeMilliseconds(),
            MaxTokens = 2048,
            MaxDurationSeconds = 60,
            Title = "Add the feature",
            Requirements = "It has to do the thing.",
            AcceptanceCriteriaJson = "[\"it does the thing\"]",
            TaskStatus = DevelopmentTaskStatus.ChangesRequested,
            TaskVersion = 1,
            ...
            PreviousRoundFeedback = previousRoundFeedback,
