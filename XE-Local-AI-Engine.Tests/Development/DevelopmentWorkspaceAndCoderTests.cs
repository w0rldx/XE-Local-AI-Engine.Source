...
public sealed class DevelopmentWorkspaceAndCoderTests : IDisposable
{
        ...
        long? acknowledgedAt = null)
    {
        return new DevelopmentExecutionSnapshot
        {
            ...
            TrustedRepositoryAcknowledged = acknowledged,
            TrustedRepositoryPolicyVersion = policyVersion,
            TrustedRepositoryAcknowledgedAtUtc = acknowledgedAt ?? DateTimeOffset.UtcNow.ToUnixTimeMilliseconds(),
            MaxTokens = 2048,
