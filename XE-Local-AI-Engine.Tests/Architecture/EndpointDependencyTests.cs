...
public sealed class EndpointDependencyTests
{
    ...
    ///     <para>
    ///         117 pairs across 98 endpoint types today: 65 a persistence store, 51 a concrete provider's contract or
    ...
    [
        "XE_Local_AI_Engine.Client.Endpoints.Agents.V1.GetAgentPlaybookMonitorEndpoint|XE_Local_AI_Engine.Client.Persistence.Stores.IAgentDefinitionStore",
        "XE_Local_AI_Engine.Client.Endpoints.Agents.V1.GetAgentUsageSummaryEndpoint|XE_Local_AI_Engine.Client.Persistence.Stores.IAgentExecutionLogStore",
        "XE_Local_AI_Engine.Client.Endpoints.Agents.V1.ListAgentExecutionLogsEndpoint|XE_Local_AI_Engine.Client.Persistence.Stores.IAgentDefinitionStore",
        "XE_Local_AI_Engine.Client.Endpoints.Agents.V1.ListAgentExecutionLogsEndpoint|XE_Local_AI_Engine.Client.Persistence.Stores.IAgentExecutionLogStore",
        "XE_Local_AI_Engine.Client.Endpoints.Agents.V1.ListAgentTemplatesEndpoint|XE_Local_AI_Engine.Client.Persistence.Stores.IAgentDefinitionStore",
        "XE_Local_AI_Engine.Client.Endpoints.Agents.V1.ListRunEnvelopesEndpoint|XE_Local_AI_Engine.Client.Persistence.Stores.IAgentExecutionLogStore",
        ...
        "XE_Local_AI_Engine.Client.Endpoints.Cloud.Codex.V1.CodexLoginEndpoint|XE_Local_AI_Engine.Providers.CodexOAuth.Contracts.ICodexLoginCoordinator",
        "XE_Local_AI_Engine.Client.Endpoints.Cloud.Codex.V1.CodexLogoutEndpoint|XE_Local_AI_Engine.Providers.CodexOAuth.Contracts.ICodexTokenStore",
        "XE_Local_AI_Engine.Client.Endpoints.Cloud.Codex.V1.CodexStatusEndpoint|XE_Local_AI_Engine.Providers.CodexOAuth.Contracts.ICodexLoginCoordinator",
        "XE_Local_AI_Engine.Client.Endpoints.Cloud.Codex.V1.CodexStatusEndpoint|XE_Local_AI_Engine.Providers.CodexOAuth.Contracts.ICodexTokenStore",
        "XE_Local_AI_Engine.Client.Endpoints.Cloud.Codex.V1.CodexStatusEndpoint|XE_Local_AI_Engine.Providers.CodexOAuth.Options.CodexOptions",
        ...
        "XE_Local_AI_Engine.Client.Endpoints.GraphWorkflows.V1.DeleteGraphWorkflowDefinitionEndpoint|XE_Local_AI_Engine.Client.Persistence.Stores.IGraphWorkflowStore",
        "XE_Local_AI_Engine.Client.Endpoints.GraphWorkflows.V1.GetGraphWorkflowDefinitionEndpoint|XE_Local_AI_Engine.Client.Persistence.Stores.IGraphWorkflowStore",
        "XE_Local_AI_Engine.Client.Endpoints.GraphWorkflows.V1.ListGraphWorkflowDefinitionsEndpoint|XE_Local_AI_Engine.Client.Persistence.Stores.IGraphWorkflowStore",
        ...
        "XE_Local_AI_Engine.Client.Endpoints.LocalModels.V1.DeleteModelLaunchArgumentsEndpoint|XE_Local_AI_Engine.Client.Persistence.Stores.IModelLaunchArgumentsStore",
        "XE_Local_AI_Engine.Client.Endpoints.LocalModels.V1.GetModelLaunchArgumentsEndpoint|XE_Local_AI_Engine.Client.Persistence.Stores.IModelLaunchArgumentsStore",
        "XE_Local_AI_Engine.Client.Endpoints.LocalModels.V1.PutModelLaunchArgumentsEndpoint|XE_Local_AI_Engine.Client.Persistence.Stores.IModelLaunchArgumentsStore",
        ...
        "XE_Local_AI_Engine.Client.Endpoints.Training.Datasets.V1.DeleteTrainingDatasetEndpoint|XE_Local_AI_Engine.Client.Persistence.Stores.ITrainingDatasetStore",
        "XE_Local_AI_Engine.Client.Endpoints.Training.Datasets.V1.GetTrainingDatasetEndpoint|XE_Local_AI_Engine.Client.Persistence.Stores.ITrainingDatasetStore",
        ...
        "XE_Local_AI_Engine.Client.Endpoints.Training.Runtime.V1.GetTrainingRuntimePrerequisitesEndpoint|XE_Local_AI_Engine.Providers.Training.Contracts.ITrainingRuntimePrerequisiteProbe",
        "XE_Local_AI_Engine.Client.Endpoints.Training.Runtime.V1.GetTrainingRuntimeStatusEndpoint|XE_Local_AI_Engine.Providers.Training.Contracts.ITrainingRuntimeService",
        "XE_Local_AI_Engine.Client.Endpoints.Training.Runtime.V1.RemoveTrainingRuntimeEndpoint|XE_Local_AI_Engine.Providers.Training.Contracts.ITrainingRuntimeService",
        "XE_Local_AI_Engine.Client.Endpoints.Training.Runtime.V1.StartTrainingRuntimeInstallEndpoint|XE_Local_AI_Engine.Providers.Training.Contracts.ITrainingRuntimeService",
