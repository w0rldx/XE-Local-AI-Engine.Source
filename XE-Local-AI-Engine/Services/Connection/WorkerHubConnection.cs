namespace XE_Local_AI_Engine.Services.Connection
{
    ...
    public sealed class WorkerHubConnection : IWorkerHubConnection
    {
        ...
        {
            return SendAsync("WorkerHello", new WorkerHelloPayload { ClientNodeId = clientNodeId }, cancellationToken);
        }
        ...
        {
            return SendAsync("InvocationAccepted", new { InvocationId = invocationId }, cancellationToken);
        }
        ...
        private HubConnection CreateHubConnection()
        {
            ...
            var connection = new HubConnectionBuilder()
                ...
                .AddJsonProtocol(jsonOptions =>
                {
                    ...
                    jsonOptions.PayloadSerializerOptions.Converters.Add(
