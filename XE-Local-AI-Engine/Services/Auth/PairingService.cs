    ...
    public sealed class PairingService : IPairingService
    {
        ...
        public async Task<PairClientResponse> PairAsync(string pairingToken, CancellationToken cancellationToken = default)
        {
            ...
            using var response = await client.PostAsJsonAsync(
                _platformOptions.Value.PairingEndpoint,
                request,
                SerializerOptions,
            ...
            _logger.LogInformation(
                "Worker node {NodeName} paired successfully with client node id {ClientNodeId}.",
                request.NodeName,
        ...
        private static async Task<PairingException> CreatePairingExceptionAsync(
