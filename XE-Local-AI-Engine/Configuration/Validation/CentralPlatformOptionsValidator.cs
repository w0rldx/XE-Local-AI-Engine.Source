namespace XE_Local_AI_Engine.Configuration.Validation
{
    using System;
    using System.Linq;
    ...
    {
        public static System.Collections.Generic.IEnumerable<string> AppendIf(
            this System.Collections.Generic.IEnumerable<string> source,
            bool condition,
            string error)
        {
