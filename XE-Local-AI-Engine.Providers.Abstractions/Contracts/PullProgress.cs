...
public sealed record PullProgress
{
    ...
    /// </summary>
    /// <remarks>
    ///     An image model is a <b>set</b> (diffusion + VAE + text encoders), so without this the UI cannot tell "the bar
    ///     restarted because part 2 began" from "the bar restarted because something went wrong".
    /// </remarks>
