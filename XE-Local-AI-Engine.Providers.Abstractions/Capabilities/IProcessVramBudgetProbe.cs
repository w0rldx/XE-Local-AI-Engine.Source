...
/// <summary>
///     Probes llama.cpp's CURRENT PROCESS VRAM BUDGET for a backend — which is not system-wide free VRAM.
/// </summary>
/// <remarks>
///     The real implementation parses <c>llama-server --list-devices</c>, which is vendor-agnostic and
///     placement-relevant, but on WDDM/Windows CUDA reports the calling process's residency budget and can ignore
///     memory held by games or other model processes. Consumers that need global admission/invalidation semantics must
///     prefer <see cref="HardwareProfile.AvailableVramBytes" /> and treat this value as a separate fallback/evidence
///     axis.
/// </remarks>
