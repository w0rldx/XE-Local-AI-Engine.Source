...
/// <summary>
///     Persistence boundary for the optional Hugging Face access token used to download gated repos.
/// </summary>
/// <remarks>
///     The token is a secret: it is stored encrypted at rest and is exposed only to the download client, which sets it
///     as an <c>Authorization: Bearer</c> header at request time. It is never logged, never placed in exceptions, never
///     in the registry manifest, and never indexed.
/// </remarks>
